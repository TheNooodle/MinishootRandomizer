...
public class FileSpriteProvider : ISpriteProvider
{
    ...
    private Dictionary<string, SpriteFileData> _spriteFiles = new Dictionary<string, SpriteFileData>()
    {
        ...
        { "BlobEnemy", new SpriteFileData("blob_enemy.png", 100, 100) },
        { "BlueCrystal", new SpriteFileData("blue_crystal.png", 100, 100) },
        { "CityBuildingTop", new SpriteFileData("city_building_top.png", 100, 100) },
        { "DarkCrystal", new SpriteFileData("dark_crystal.png", 100, 100) },
        { "DeadPlayer", new SpriteFileData("dead_player.png", 100, 76)},
        { "GoldenCrystalShard", new SpriteFileData("golden_crystal_shard.png", 84, 72)},
