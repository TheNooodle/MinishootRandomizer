...
public class YamlTestSuiteProviderTest
{
    ...
    public void GetLogicTestSuite_ShouldReturnCorrectLogicTestSuite()
    {
        ...
        var yamlTestSuiteProvider = new YamlTestSuiteProvider(yamlFilePath, itemRepositoryStub.Object, locationRepositoryStub.Object);
        ...
        Assert.Equal(2, logicTestSuite.TestData[0].Assertions.Count);
        ...
        Assert.Equal(2, testDataWithLogicState[1].Item1.Assertions.Count);
